...
<div class="mySlides">
       ...
       <a target="_blank" href="https://www.louriv.com"><img src="{% static 'media/louriv.png' %}"></a>
       <div class="text">LouRiv Accessorize</div>
</div>

<div class="mySlides">
       <a target="_blank"  href="https://www.docisbijoux.it"><img src="{% static 'media/docis.png' %}"></a>
       <div class="text">Doci's Bijoux</div>
</div>

<div class="mySlides">
 
       <a target="_blank"  href="https://www.roriaccessorize.com"><img src="{% static 'media/rori.png' %}"></a>
